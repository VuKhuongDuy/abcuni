<template>
    <div id="home">   
        ...
        <!-- table -->
        <b-table striped hover :items="listAll"
    ...
    data() {
      return {
        ...
        options_subject: [
          ...
          {value: 'INT3507', text: 'Các vấn đề hiện đại của Công nghệ thông tin'},
        ...
        listAll:[
            {name_subject: 'Chuyên nghiệp trong công nghệ',date:'24/12/2019',time: "07:30",room: '101-G2', number_of_computer: 20},
            {name_subject: 'Các vấn đề hiện đại của Công nghệ thông tin',date:'24/12/2019',time: "09:00",room: '103-G2', number_of_computer: 14},
            {name_subject:'An toàn và an ninh mạng',date:'24/12/2019',time: "13:00",room: '107-G2', number_of_computer:12},
            {name_subject: 'Phát triển ứng dụng Web',date:'24/12/2019',time: "15:30",room: '108-G2', number_of_computer: 16},
        ]
      }
    }
}
